...
program principal 
  ...
  open(33,file='fig2C-mub_nm1.dat'); !exchanged species only
  open(34,file='fig2C-mu_nm1.dat'); !all species
  open(38,file='fig2C-reac_nm1.dat'); !all species
  open(37,file='fig2C-reacb_nm1.dat'); !exchange species only
  open(39,file='fig2C-mean_nm1.dat'); 
